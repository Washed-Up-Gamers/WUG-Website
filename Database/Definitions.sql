...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    button1text text NULL,
    button1link text NULL,
    button2text text NULL,
    button2link text NULL,
    button3text text NULL,
    button3link text NULL,
...
CREATE TABLE IF NOT EXISTS powergrids (
    id bigint GENERATED BY DEFAULT AS IDENTITY,
    mainnationid bigint NOT NULL,
    name text NOT NULL,
    nationids bigint[] NOT NULL,
    powersupply double precision NOT NULL,
    powerdemand double precision NOT NULL,
    averageprice numeric(30,4) NOT NULL,
    CONSTRAINT pk_powergrids PRIMARY KEY (id)
);


CREATE TABLE IF NOT EXISTS pricestats (
    id bigint GENERATED BY DEFAULT AS IDENTITY,
    resourceprices jsonb NOT NULL,
    ppi numeric NOT NULL,
    time timestamp with time zone NOT NULL,
    CONSTRAINT pk_pricestats PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS producingbuilding (
    ...
    sellingprice numeric(30,4) NULL,
    powerbrought double precision NULL,
    name text NULL,
    nationid bigint NOT NULL,
    size integer NOT NULL,
    prevrecipeid text NOT NULL,
...
CREATE TABLE IF NOT EXISTS senators (
    nationid bigint GENERATED BY DEFAULT AS IDENTITY,
    userid bigint NOT NULL,
    CONSTRAINT pk_senators PRIMARY KEY (nationid)
);
